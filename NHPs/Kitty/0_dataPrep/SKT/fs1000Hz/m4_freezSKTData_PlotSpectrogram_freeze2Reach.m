...
[tbl_freezEpisodes]= tbl_freezEpisodes_extract(files, 't_bef', 1, 't_aft', 1);
tbl_reachFreezEpisodes = tbl_freezEpisodes(strcmp(tbl_freezEpisodes.freezType, "reachFreeze"),:);
clear tbl_freezEpisodes


plot_spectrogramMA_freeze2Reach_acrossTrials(tbl_reachFreezEpisodes, f_AOI, savefolder);


if plotTrialbyTrial
    plot_spectrogram_trialbytrial(tbl_reachFreezEpisodes, freezeType, f_AOI, fullfile(savefolder, 'trialSpectrogram'));
end
clear freezeType
...
function plot_spectrogramMA_freeze2Reach_acrossTrials(tbl_freezEpisodes, f_AOI, savefolder)

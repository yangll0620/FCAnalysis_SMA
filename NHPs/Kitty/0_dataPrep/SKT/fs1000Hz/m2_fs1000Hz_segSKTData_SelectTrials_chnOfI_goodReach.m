function m2_fs1000Hz_segSKTData_SelectTrials_chnOfI_goodReach(varargin)
%  plot spectrogram of each trial and manually select trials only use good
%  reach trials
%
%   Example:
%       m2_segSKTData_SelectTrials_chnOfI_goodReach_fs1000Hz('fi_str', 1, 'autoSaveMode', 'y')
%   
%   Input:
%       Name-Value: 
%           animal
...
inputfolder = fullfile(codecorresParentfolder, 'm1_fs1000Hz_segSKTData_avgArea');

function m4_fs500Hz_FreezeSKT_earlyMiddLateFreeze_imCohUsingFFT2(freezePhase, varargin)
% 
%   Usage
%       m4_fs500Hz_FreezeSKT_earlyMiddLateFreeze_imCohUsingFFT2('earlyFreeze', 'ntrialsUsed', 84, 'nRandom', 10);
%       m4_fs500Hz_FreezeSKT_earlyMiddLateFreeze_imCohUsingFFT2('middleFreeze', 'ntrialsUsed', 84);
%       m4_fs500Hz_FreezeSKT_earlyMiddLateFreeze_imCohUsingFFT2('lateFreeze', 'ntrialsUsed', 84);
%
%   Input
...
show_textPair = false;
show_colorbar = false;
if strcmp(freezePhase, 'earlyFreeze')
    show_textPair = true;
end
...
plot_ciCohHistogram(sigciCoh_flatten, chnPairNames, f_selected, titlename, ...
    'fig_width', 400, 'fig_height', 200, 'margin_inner', [60 5 50 50],...
    'codesavefolder', savecodefolder, ...
    'show_titlename', false, 'show_xlabel', show_freqNumLabel, 'show_yticklabels', show_textPair, ...

function m1_segSKTData_avgArea()
...
inputfolder = fullfile(codecorresParentfolder, 'm0_fs500Hz_NormalCOTModerateSKTData_extract_Kitty');
...
for fi = 1 : nfiles
    ...
    tmpn = length([animal]);
    savefilename = [filename(idx:idx + tmpn - 1) '_' savefilename_addstr ...

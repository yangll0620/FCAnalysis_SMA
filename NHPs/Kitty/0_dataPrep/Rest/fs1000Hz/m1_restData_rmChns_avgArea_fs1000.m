function m1_restData_rmChns_avgArea_fs1000()
    ...
    % input folder
    input_folder = fullfile(datafolder, 'Animals', animal, 'root2', 'Ying Yu', 'SKB_EventRelatedBeta', 'datasets_Allanimals', 'Resting');
    ...
    unwanted_DBS = unwanted_DBS_extract(animal, codesavefolder);

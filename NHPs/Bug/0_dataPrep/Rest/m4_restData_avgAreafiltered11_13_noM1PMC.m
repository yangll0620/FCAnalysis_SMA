function m4_restData_avgAreafiltered11_13_noM1PMC()
    %% narrow filtered rest data recorded with grayMatter in frequency [11 13]Hz
    %
...
function [filted_lfp_segs, T_chnsarea_new, fs]= avgAreafilter_seg_1file(file, frebp, segt)
    ...
    % extract uniqBrainAreas without "", "M1" and "PMC"
    mask_removearea = cellfun(@(x) isempty(x)||strcmp(x, 'M1')||strcmp(x, 'PMC')||strcmp(x, 'GPe')||strcmp(x, 'GPi'), T_chnsarea.brainarea);
    uniqBrainAreas = unique(T_chnsarea.brainarea(~mask_removearea));

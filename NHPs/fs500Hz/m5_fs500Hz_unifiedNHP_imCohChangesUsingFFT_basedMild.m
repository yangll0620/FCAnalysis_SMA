function m5_fs1000Hz_unifiedNHP_imCohChangesUsingFFT_basedMild(animal, varargin)
%
%   Input:
%       animal
%
...
%%  input setup
inputfolder_ciCohSKT = fullfile(SKTCodecorresParentfolder, 'm4_fs500Hz_unifiedNHP_chnOfI_imCohPhaseUsingFFT_EventPhase');

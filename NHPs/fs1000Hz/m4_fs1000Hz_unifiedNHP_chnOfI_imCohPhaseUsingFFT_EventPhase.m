function m4_fs1000Hz_unifiedNHP_chnOfI_imCohPhaseUsingFFT_EventPhase(animal, varargin)
%
%   Input:
%       animal
%
...
if segVFolder  
    ...
    SKTSubfolder = 'SKT';
    SKTDataSubfolder = 'm2_SKTData_SelectTrials_goodReach_fs1000Hz';
end
NHPCodefilepath = fullfile(codefolder, 'NHPs', animal, '0_dataPrep' , SKTSubfolder, 'fs1000Hz', codefilename);

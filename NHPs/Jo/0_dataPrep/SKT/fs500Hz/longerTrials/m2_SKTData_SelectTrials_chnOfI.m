function m2_SKTData_SelectTrials_chnOfI(varargin)
%  plot spectrogram of each trial and manually select trials only use good
%  reach trials
%
%   Example:
%       m2_SKTData_SelectTrials_chnOfI('fi_str', 1, 'autoSaveMode', 'n')
%   
%   Input:
%       Name-Value: 
%           animal
...
if strcmpi(autoSaveMode, 'y') % autoSaveMode
    ...
    function plot_spectrogram()
        ...
        cbx_showMAThreshold = uicontrol('Style','checkbox','Value', 1, 'Position', [cbxShowThre_pos_left cbxShowThre_pos_bottom cbxShowThre_pos_width cbxShowThre_pos_height], 'String', 'Show Threshold = 30');

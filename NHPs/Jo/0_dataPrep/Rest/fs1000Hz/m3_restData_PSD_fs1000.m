function m3_restData_PSD_fs1000()
...
% input folder
inputfolder = fullfile(codecorresParentfolder, 'm2_restData_selectSeg_Power_fs1000Hz');
...
file_psdall = fullfile(savefolder, [savefilename_prefix '_allsegs_normalmildmoderate_' num2str(plotF_AOI(1)) '-' num2str(plotF_AOI(2))   'Hz.mat']);

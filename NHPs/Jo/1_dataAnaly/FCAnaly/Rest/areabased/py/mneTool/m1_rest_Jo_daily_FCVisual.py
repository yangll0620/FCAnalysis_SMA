...
from lfp_ciCOH_extract import lfp_extract
...
def main():
    ...
    cond = 'normal'
    metricfiles_normal = glob.glob(os.path.join(savefolder, 'metric_*_' + cond + '_*.pickle'))
    ...
    plt.savefig(os.path.join(savefolder, 'visualcc.png'))

...
w_colormap = 200; % width  for the colormap
h_colormap = 100; % height for the colormap
...
for rowi = 1 : nrows
    ...
    w_inner_right = 0;
    w_outer_right = 5;
    w_outer_diff = w_textPowerLabel + w_textPowerNum + w_colormap;
    ...
    close all
    fig_width = w_outer_left + w_outer_diff;
    fig_height = w_outer_diff;
    fig = figure('Position', [250 150 fig_width fig_height]);

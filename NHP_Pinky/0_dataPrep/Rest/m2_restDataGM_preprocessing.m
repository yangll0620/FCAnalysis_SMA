function m1_restDataGM_preprocessing()
%% preprocessing rest data recorded with grayMatter
%
...
inputfolder = fullfile(pipelinefolder, ['NHP_' animal], '0_dataPrep', 'm0_restDataGM_extract');
...
for chi = 1 : size(reflfp, 2)
    filterdreflfp(:, chi) = filter_bpbutter(reflfp(:,chi),frebp,fs_down);
end

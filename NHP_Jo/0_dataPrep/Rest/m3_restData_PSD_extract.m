...
%  textbox
text(F_maxPSD - 0.2, maxPSD + maxPSD * 0.3, ['F_{mild} = ' num2str(F_maxPSD)])


[maxPSD, idx]= max(psd_normal_mean);
F_maxPSD = round(F_AOI(idx));
plot([F_maxPSD F_maxPSD], [0 maxPSD + maxPSD * 0.2], 'k--')
%  textbox
text(F_maxPSD - 0.2, maxPSD + maxPSD * 0.3, ['F_{normal} = ' num2str(F_maxPSD)])
